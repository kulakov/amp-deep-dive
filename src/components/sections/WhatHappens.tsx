  ...
  return <section className="py-24 px-6 border-b border-callout-border bg-background relative z-10">
      ...
      <div className="max-w-3xl mx-auto mb-12">
        <div className="space-y-6">
          ...
          <p className="text-lg font-body leading-relaxed">Мы собираем в одном месте людей, которым точно захочется искренне и глубоко пообщаться. Искать таких сложно. Вы можете делать это сами, но на это вечно не хватает времени. А еще непонятно, где их брать. Поэтому их надо собрать их в кучу. Вот мы и собрали.</p>
        </div>
      </div>
      ...
      <div ref={galleryRef} className="hidden md:block relative h-[450px] max-w-6xl mx-auto">
        ...
        return <div key={i} className={`absolute ${item.size} bg-white p-2 shadow-xl cursor-pointer transition-all duration-300 ease-out group
      ...
      <div className="max-w-3xl mx-auto space-y-20">
        {/* What is it */}
        <div className="space-y-6">
          <p className="text-lg font-body leading-relaxed">AmpCamp — это место, где технический директор может обнаружить, что его тревога про будущее точно такая же, как у учителя литературы, хотя внешне их жизни не похожи.<strong>технический директор </strong> может обнаружить, 
        ...
        <div className="bg-callout border border-callout-border p-6 font-mono text-sm space-y-3">
          ...
          <div className="space-y-2 text-callout-foreground">
            ...
            <p className="font-medium text-foreground">Если вы участвуете, ничего не вкладывая — скорее всего не получите отдачи.</p>
          </div>
        </div>
      </div>
    </section>;
