      ...
      <div className="max-w-5xl mx-auto space-y-12">
        <div className="space-y-8">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 text-2xl font-bold hover:text-accent transition-colors group"
          >
        ...
        <div className="pt-8 border-t-2 border-primary-foreground/20">
