...
const Sticker = ({
  ...
  return <div onClick={!isFixed ? onClick : undefined} className={`
    ...
    transform: isFixed ? "rotate(0deg)" : `rotate(${initialRotation}deg)`
      ...
      <div 
        className="absolute inset-0 bg-highlight/30 -z-10"
        style={{
      ...
      <div className="h-full flex items-center justify-center">
        <p className="text-xs md:text-sm font-body text-center leading-snug text-foreground">
          {text}
        </p>
      </div>
      ...
      transitionDelay: isFixed ? "200ms" : "0ms"
        ...
        <svg width="14" height="20" viewBox="0 0 64 94" className="fill-foreground">
