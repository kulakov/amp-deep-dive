...
const WorthIt = () => {
  ...
  const benefits = [{
    ...
    description: <>Место, где можно говорить без непрошенных советов и мотивационных речей. Кроме чатов у нас есть другие онлайн форматы: <span className="underline decoration-highlight decoration-2 underline-offset-4">дискуссии</span>, <span className="underline decoration-highlight decoration-2 underline-offset-4">мастер-майнды</span> и всякое, что мы периодически делаем, потому что кто-то упоролся.</>,
    img: doodleChat,
    rotate: 4
  }, {
    title: "Понимание",
        ...
        <div className="max-w-6xl mx-auto px-6 py-8 md:py-16 space-y-8">
          ...
          <div className="md:hidden overflow-x-auto overflow-y-visible -mx-6 px-6 -mb-4">
            ...
            width: 'max-content'
              ...
              {benefits.map((benefit, i) => <div key={i} className="w-[260px] flex-shrink-0 bg-background shadow-xl">
                  <div className="aspect-[2/1] overflow-hidden bg-white">
                    <img src={benefit.img} alt={benefit.title} loading="lazy" className="w-full h-full object-contain" />
                  </div>
                  <div className="p-4">
          ...
          <div className="hidden md:block relative h-[550px]">
            ...
            return <div key={i} className="absolute w-[300px] bg-background shadow-xl cursor-pointer transition-all duration-300 group" style={{
