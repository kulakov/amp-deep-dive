    ...
    <section className="py-32 px-6">
      <div className="max-w-5xl mx-auto space-y-20">
        <div className="space-y-8">
          <h2 className="text-5xl md:text-7xl font-black">КАК МНЕ ПОПАСТЬ НА КЭМП?</h2>
        </div>

        <div className="space-y-8">
          <h3 className="text-4xl font-bold">Как проходит отбор</h3>
          <blockquote className="text-xl italic border-l-4 border-accent pl-6 text-muted-foreground">
        ...
        <div className="space-y-8">
          <h3 className="text-4xl font-bold">Зачем интервью</h3>
        ...
        <div className="space-y-8">
          <h3 className="text-4xl font-bold">Что происходит на интервью</h3>
          <div className="space-y-6 text-lg">
            <p>
            ...
            <div className="p-6 bg-muted border-l-4 border-accent">
