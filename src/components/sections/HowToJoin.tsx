const HowToJoin = () => {
  const steps = [{
    ...
    title: "Интервью",
    description: "Мы пытаемся почувствовать, какими вы будете на кэмпе и что интересного вы с собой принесете. А вы пытаетесь понять, не секта ли мы."
  }, {
    title: "Решение",
      ...
      <div className="max-w-3xl mx-auto space-y-16">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground text-lg">
            ...
            <p>
              А еще мы хотим, чтобы встретились люди, которые друг друга в чем-нибудь усилят. Мы пытаемся разглядеть в вас вашу фишку. Именно поэтому мы не берем не всех.
            </p>
          </div>
        </div>
          ...
          <div className="relative z-10 px-6 md:px-12 py-16 space-y-12 text-foreground">
            ...
            <div className="border-l-2 border-highlight pl-6">
              ...
              <p className="italic text-muted-foreground">
                Представьте, что к вам пришел волшебник и говорит: "Я могу сделать так, чтобы ты не умирал. Что вы про это думаете? Согласились ли бы вы? А другие люди согласятся или нет, как вы думаете?"
              </p>
              <p className="text-xs mt-3 text-muted-foreground">
                (Это просто пример, такого вопроса не будет на интервью)
              </p>
            </div>
        ...
        <div className="border-t border-callout-border pt-6 space-y-3">
          <h4 className="font-display font-bold italic text-foreground">Про стресс на интервью</h4>
          <div className="space-y-3 text-muted-foreground font-body text-lg leading-relaxed">
            ...
            <p>
              Интервью не идеально. Иногда мы ошибаемся и отказываем тому, кого стоило взять. Но это лучшее из того, что мы придумали, чтобы кэмп был классный.
            </p>
            <p>
              Если вам кажется, что интервью прошло неудачно и вам не удалось раскрыться, мы готовы еще раз проинтервьюировать вас на следующий кэмп.
            </p>
          </div>
        </div>
      </div>
