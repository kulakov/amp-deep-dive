  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        "silly-2": ["Cormorant Garamond", "serif"],
        "silly-3": ["Unbounded", "sans-serif"],
        "silly-4": ["Lora", "serif"],
        "silly-5": ["Oswald", "sans-serif"],
        "silly-6": ["Raleway", "sans-serif"],
        "silly-7": ["Montserrat", "sans-serif"],
        "silly-8": ["Jost", "sans-serif"],
        "silly-9": ["Manrope", "sans-serif"],
        "silly-10": ["JetBrains Mono", "monospace"],
      },
      colors: {
